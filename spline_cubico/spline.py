...
#(1,1), (2,4), (4,2), (5,3)
x = [-6.997, -4.642, -3.236, -2.747, -0.222, 1.774, 3.809, 4.001, 7.222, 8.158, 10.079, 11.386, 12.652]
y = [1.713, 4.279, 3.745, 3.364, 3.778, 4.875, 2.897, 2.709, 3.068, 2.736, 0.005, -1.246, -1.25]
eqs = spline(x, y)
print(eqs)
